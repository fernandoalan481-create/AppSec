...
Autor: Alan Fernando github.com/fernandoalan481-create
Descrição: Este script serve como um hub centralizado para acessar várias ferramentas de segurança ofensiva.
"""
...
TOOLS = {
    ...
    "3": {
        "name": "All seeying Eye OSINT",
        "desc": "Modular OSINT Framework",
        "path": "Osint/main.py"
    },

     "4": {
        "name": "Dirbull Diretory Bruteforcer",
        "desc": "Powerful Directory Bruteforcer",
        "path": "dirbull/dirbull.py"
    }
}
